...
You don't always have to have long keybindings in "file" and "toggle" sections, though. Here is a simple-if-not-mnemonic =SPC .= for opening or creating a file. (And you can also launch =dired= with it!) This is such a common command that it's good not to bury it.
