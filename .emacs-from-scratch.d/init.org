...
Allows you to select some text in Visual State and then hit =*= or =#= to search for that text. Another very occasionally very useful trick.
...
Shows you the difference between two different bits of text. Very occasionally very useful!
