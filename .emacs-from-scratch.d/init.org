...
Let's look at a picture of the view I'm looking at right now:

[[./assets/font-setup-screenshot.jpg]]

The main text you see, including the heading "Fonts" and the line, "First, some definitions of the fonts I use", uses "IBM Plex Serif", which is a standard-style variable-pitch serif font. It's "serif" because it's /fancy/. If you look close, you can see that some of the letters have extra little curly bits, called serifs.
