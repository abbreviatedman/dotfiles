...
**** Searching The Visible Buffer

What I'm trying now is:

1. =evil-snipe= for short-range hops.
2. =evil-ex-search= for long-range hops.
3. =consult-line= if I want to use =orderless= filtering or do something with the list of results.

Do I need 3 searches? /Probably not/. I'll figure out what workflow works for me in time.

But I'm also going to try Avy every once in a while, see if I like it. So... maybe I need 4.
...
Let's make a nice completion menu to work with.
...
#+begin_src emacs-lisp
  (use-package copilot
    ...
    (crj-leader-keys "tc" '(global-copilot-mode :which-key "Toggle copilot."))
