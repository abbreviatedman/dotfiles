...
#+begin_src emacs-lisp
  (use-package emacs
    :general
    (crj-leader-keys "f" '(:ignore t :which-key "files")))
#+end_src
...
#+begin_src emacs-lisp
  (use-package evil-collection
    ...
    (:keymaps 'evil-collection-unimpaired-mode-map
     ...
     "[l" 'evil-collection-unimpaired-move-text-up
     "]l" 'evil-collection-unimpaired-move-text-down))
#+end_src
...
=flyspell-correct= makes it even better with a quick command to correct the last word. You can correct your spelling /so/ easily without losing your flow in the slightest.
