...
2. =avy-goto-char-timer= for medium-range hops.
3. =evil-ex-search= for long-range hops.
4. =consult-line= for a more focused search.

Do I need 4 searches? /Probably not/. I'll figure out what workflow works for me.
