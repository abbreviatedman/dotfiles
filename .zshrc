...
# Some Emacs variables.
export CRAFTED_EMACS_HOME=~/.config/crafted-emacs
export DOOMDIR=~/.doom.d

export PATH=/usr/lib:$ANDROID_HOME/tools:$ANDROID_HOME/tools/bin:$ANDROID_HOME/platform-tools:/usr/local/bin:.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:~/Applications:~/.cargo/bin/snap/bin:/Android/Sdk/tools:/Android/Sdk/tools/bin:/Android/Sdk/platform-tools:/usr/bin:/snap/bin:/.fzf/bin:/Android/Sdk/tools:/Android/Sdk/tools/bin:/Android/Sdk/platform-tools:/usr/bin:/snap/bin:~/doom-emacs/bin:~/.emacs.d/bin:/.local/kitty.app/bin:~/.local:$HOME/go/bin:$HOME/.local/bin:$HOME/.npm-global
...
__conda_setup="$('/home/abbreviatedman/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/abbreviatedman/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/abbreviatedman/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/abbreviatedman/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
